 ...
 * @endcode
 */
$settings['hash_salt'] = '1-loi0wZaq1JFTIKV4dnSz0CLG0oWJXJP7RlBpjoDJAYJufbYuU3s4gjU8BER3km17rdxMSTcA';
 ...
 */
#
$configfile = dirname(__DIR__, 4) . '/settings.php';
if (file_exists($configfile)) {
   include $configfile;
}

$databases['default']['default'] = array (
  'database' => $MYSQL_DATABASE_ALTALANOS,
  'username' => $MYSQL_USER,
...
$settings['config_sync_directory'] = 'sites/default/files/config_onzInyCKDpuDW1HzfUHDL5JcC2PSTKi7LNqWOIQIxKJccFQYuNNePfbq-IJLOlP-mTGDNmLlvA/sync';
